...
This project is based on and modified from [VectifyAI/PageIndex](https://github.com/VectifyAI/PageIndex).

The original project is released under the MIT License. Copyright belongs to Vectify AI.

I have used this project for learning, modification, and secondary development.
